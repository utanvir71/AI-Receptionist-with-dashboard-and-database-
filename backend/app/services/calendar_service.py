"""Legacy Google Calendar storage implementation.

The active storage-neutral boundary lives in ``app.services.reservation_store``.
This module keeps Google Calendar support and compatibility aliases for older
imports while runtime Vapi storage is migrated to the database.
"""
...
ReservationCalendar = ReservationStore
InMemoryCalendarService = InMemoryReservationStore
